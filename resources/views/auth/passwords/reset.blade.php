    ...
    <div class="max-w-md mx-auto my-10 bg-white p-5 rounded-lg shadow-lg">
        ...
        <form method="POST" action="{{ route('password.update') }}" class="mt-4">
            ...
            <div class="mb-4">
                ...
                <input type="email" id="email" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-blue-500">
                @error('email')
